    ...
    for(int ii=0; ii<Nlive; ii++){
     ...
     //if(tdibujo>tcuadro){
		...
		InicieCuadro();
			for(int ii=0;ii<Nlive;ii++){
					Bichitos[ii].Print();
					//Bichin<<"\t"<<Bichitos[ii].Getx()<<"\t"<<Bichitos[ii].Gety()<<"\t" << food[ii].Alive();
